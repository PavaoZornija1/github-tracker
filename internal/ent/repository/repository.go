...
const (
	...
	// EdgeRefreshJobs holds the string denoting the refresh_jobs edge name in mutations.
	EdgeRefreshJobs = "refresh_jobs"
	// Table holds the table name of the repository in the database.
	Table = "repositories"
	// RefreshJobsTable is the table that holds the refresh_jobs relation/edge.
	RefreshJobsTable = "refresh_batch_jobs"
	// RefreshJobsInverseTable is the table name for the RefreshBatchJob entity.
	// It exists in this package in order to avoid circular dependency with the "refreshbatchjob" package.
	RefreshJobsInverseTable = "refresh_batch_jobs"
	// RefreshJobsColumn is the table column denoting the refresh_jobs relation/edge.
	RefreshJobsColumn = "repo_id"
)
...
// ByRefreshJobsCount orders the results by refresh_jobs count.
func ByRefreshJobsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newRefreshJobsStep(), opts...)
	}
}

// ByRefreshJobs orders the results by refresh_jobs terms.
func ByRefreshJobs(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newRefreshJobsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
func newRefreshJobsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(RefreshJobsInverseTable, FieldID),
